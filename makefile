...
.PHONY: build destroy apply teardown-apply deploy-net deploy-file run-sender wait-sender collect all
...
all: build deploy-net deploy-file run-sender wait-sender collect